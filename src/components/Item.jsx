    ...
    return (
        <div className="my-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-purple-200 bg-white hover:shadow-lg hover:shadow-purple-950">
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <Link to={`/detail/${product.id}`} className="flex items-center justify-center rounded-md bg-purple-950 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-purple-800">VER MAS</Link>
            </div>
        </div>
    )
}
